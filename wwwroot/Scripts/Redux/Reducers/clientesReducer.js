...
var clientesReducer = function clientesReducer() {
  ...
  var _ref = window.ClientesActions || {},
    TYPES = _ref.TYPES;
  if (!TYPES) {
    return state;
  }
  switch (action.type) {
    ...
    case TYPES.ACTUALIZAR_CLIENTE:
      return _objectSpread(_objectSpread({}, state), {}, {
        lista: state.lista.map(function (c) {
          return c.fidCliente === action.payload.fidCliente ? _objectSpread(_objectSpread({}, c), action.payload) : c;
        })
      });
    case TYPES.ELIMINAR_CLIENTE:
      return _objectSpread(_objectSpread({}, state), {}, {
        lista: state.lista.map(function (c) {
          return c.fidCliente === action.payload ? _objectSpread(_objectSpread({}, c), {}, {
            factivo: false
          }) : c;
        })
      });
