...
var ROLE_CONSTANTS = {
  ...
  getRoleCode: function getRoleCode(roleName) {
  ...
  isAdmin: function isAdmin(roleCode) {
  ...
  isUser: function isUser(roleCode) {
  ...
  getUserRoleCode: function getUserRoleCode(usuario) {
