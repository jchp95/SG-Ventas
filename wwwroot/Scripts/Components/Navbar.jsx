const Navbar = () => {
    ...
    // Redux hooks
    const {tema, setTema, usuario} = window.ReduxProvider.useApp();
    const {logout, loading: authLoading} = window.ReduxProvider.useAuth();
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li className="navbar-link dropdown d-none d-lg-block me-4">
                            ...
                            >
                                <li>
                                    <Link className="dropdown-item mb-2" to="/auditoria"><i
                                        className="bi bi-clipboard-data me-2"></i> Auditoría</Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item mb-2" to="/settings"><i
                                        className="bi bi-building me-2"></i> Datos Empresa</Link>
                                </li>
                                <li>
                                    <Link className="dropdown-item" to="/usuarios"><i
                                        className="bi bi-person-plus me-2"></i> Administrar usuarios</Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div className="d-flex flex-column px-3 d-lg-none">
                            ...
                            <Link
                                className={`nav-link d-flex align-items-center mb-3 ${tema === 'dark' ? 'text-white' : 'text-dark'}`}
                                to="/auditoria">
                                <div className="me-3" style={{width: '30px', textAlign: 'center'}}>
