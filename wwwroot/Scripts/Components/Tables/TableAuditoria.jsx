...
function TableAuditoria(props) {
    ...
    const tipoAuditoria = props.tipoAuditoria || 'tenant'; // 'tenant' o 'usuarios'
        ...
        return [
            {
                ...
                Cell: function ({row}) {
                    ...
                    return React.createElement('div', {className: 'fecha-cell'},
                ...
                Cell: function ({value, row}) {
                    ...
                    if (tipoAuditoria === 'usuarios' && row.original.nombre_completo) {
                        return React.createElement('div', {className: 'd-flex flex-column'},
                            React.createElement('span', {className: 'fw-semibold'}, row.original.nombre_completo),
                            React.createElement('small', {className: 'text-muted'}, `@${row.original.nombre_usuario}`)
                        );
                    }
            ...
            },
            {
                ...
                Cell: function ({value, row}) {
                    ...
                    return React.createElement('span', {
                        className: `badge badge-${getActionColor(accionNombre)}`
                    }, accionNombre);
                }
            },
            {
            ...
            },
            {
                ...
                Cell: function ({value}) {
                    return React.createElement('div', {className: 'pc-cell'}, value || 'N/A');
                }
            },
            {
                Header: 'Sincronizado',
    ...
    if (data.length === 0) {
        return React.createElement('div', {className: 'text-center p-5'},
            React.createElement('p', {className: 'text-muted'}, 'No hay registros de auditoría para mostrar.')
        );
    }

    return (
        React.createElement(React.Fragment, null,
            React.createElement('div', {className: 'auditoria-table-section'},
