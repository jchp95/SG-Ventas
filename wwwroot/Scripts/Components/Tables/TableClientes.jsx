function TableClientes(props) {
    ...
    var columns = React.useMemo(function () {
        return [
            ...
            {Header: 'Número Cliente', accessor: 'fnumeroCliente'},
            {Header: 'Cédula/RNC', accessor: 'fcedulaRnc'},
            {Header: 'Nombre', accessor: 'fnombre'},
            {Header: 'Teléfono', accessor: 'ftelefono'},
            {Header: 'Celular', accessor: 'fcelular'},
            {Header: 'Dirección', accessor: 'fdireccion'},
            {Header: 'Fecha Nacimiento', accessor: 'ffechaNacimiento'},
            {Header: 'Ruta', accessor: 'ruta'},
            {Header: 'Tipo Entidad', accessor: 'ftipoEntidad'},
            {Header: 'Calle', accessor: 'fcalle'},
            {Header: 'Límite Crédito', accessor: 'flimiteCredito'},
            {Header: 'Foto', accessor: 'fdirFoto'},
            {Header: 'Ubicación GPS', accessor: 'fubicaciongps'},
            ...
            {Header: 'Actividad Comercial', accessor: 'actividadComercial'},
