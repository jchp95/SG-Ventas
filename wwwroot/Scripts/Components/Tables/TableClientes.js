...
function TableClientes(props) {
  ...
  var columns = React.useMemo(function () {
    return [{
      ...
      accessor: 'ffechaNacimiento'
    }, {
      Header: 'Ruta',
      accessor: 'ruta'
    }, {
      Header: 'Tipo Entidad',
      accessor: 'ftipoEntidad'
    }, {
      Header: 'Calle',
      accessor: 'fcalle'
    }, {
      Header: 'Límite Crédito',
      accessor: 'flimiteCredito'
    }, {
      Header: 'Foto',
      accessor: 'fdirFoto'
    }, {
      Header: 'Ubicación GPS',
      accessor: 'fubicaciongps'
    }, {
      Header: 'Estado Civil',
      ...
      Cell: function Cell(cell) {
        ...
        }, 'Editar'), cell.row.original.activo ? React.createElement('button', {
